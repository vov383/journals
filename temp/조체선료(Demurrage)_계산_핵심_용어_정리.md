---
title: 조체선료(Demurrage)_계산_핵심_용어_정리
...
- 체선료 (Demurrage)
    ...
    사용 정박시간이 허용 정박시간을 초과했을 때 발생하는 지체료입니다. 
    초과된 시간에 일일 조체선료율(Rate)을 곱하여 산정합니다.
    ($/DAY)
    
- 조출료 (Despatch)
    
    반대로, 사용 정박시간이 허용 정박시간보다 짧을 때, 즉 작업을 빨리 끝냈을 때 선주가 화주에게 지급하는 장려금입니다. 
    통상 조체선료율의 50%가 적용됩니다.
    ($/DAY)
